 ...
 * @param <T>
 */
public class CollectionUtils<T> implements Iterable<T> {
	...
	private CollectionUtils(final Collection<T> source) {
		if (source == null) {
	 ...
	 * @return
	 */
	public static <T> CollectionUtils<T> from(final Collection<T> source) {
		return new CollectionUtils<T>(source);
	}
	 ...
	 * @return
	 */
	public static <T> CollectionUtils<T> from(final T... source) {
	 ...
	 * @return
	 */
	public CollectionUtils<T> concat(final Collection<T> items) {			
	 ...
	 * @return
	 */
	public CollectionUtils<T> concat(final T... items) {
	 ...
	 * @return
	 */
	public CollectionUtils<T> filter(final Predicate<T> predicate) {
	 ...
	 * @return
	 */
	public <V> CollectionUtils<V> map(final Condition<T, V> condition) {
	 ...
	 * @return
	 */
	public CollectionUtils<T> skip(int count) {
	 ...
	 */
	public CollectionUtils<T> take(final int start) {		
		final Iterator<T> it = source.iterator();
		if (start <= 0) {
			return empty();
		}
	 ...
	 * @return
	 */
	private static <T> CollectionUtils<T> empty() {
		return new CollectionUtils<T>(null);
	}	
}